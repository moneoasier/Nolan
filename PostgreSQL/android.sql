insert into sale_order(id,name,state,date_order,user_id,partner_id,partner_invoice_id,partner_shipping_id,pricelist_id,currency_id,invoice_status,amount_untaxed,amount_tax,amount_total,currency_rate,company_id,team_id,picking_policy,warehouse_id,effective_date)
values (ID_OSIG,S_ULTIMO,"draft",now(),U_ID,P_ID,P_ID,P_ID,1,1,"no",PRECIO,IVA,PRECIO+IVA,1,1,5,"direct",1,current_date());
