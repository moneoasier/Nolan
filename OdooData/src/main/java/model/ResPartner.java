...
public class ResPartner implements Serializable {
	...
	public void setResUsers(List<ResUser> resUsers) {
		this.resUsers = resUsers;
	}

	public ResUser addResUser(ResUser resUser) {
		getResUsers().add(resUser);
		resUser.setResPartner(this);

		return resUser;
	}

	public ResUser removeResUser(ResUser resUser) {
		getResUsers().remove(resUser);
		resUser.setResPartner(null);
	...
	public SaleOrder addSaleOrders1(SaleOrder saleOrders1) {
		...
		saleOrders1.setResPartner1(this);
	...
	public SaleOrder removeSaleOrders1(SaleOrder saleOrders1) {
		...
		saleOrders1.setResPartner1(null);
	...
	public SaleOrder addSaleOrders2(SaleOrder saleOrders2) {
		...
		saleOrders2.setResPartner2(this);
	...
	public SaleOrder removeSaleOrders2(SaleOrder saleOrders2) {
		...
		saleOrders2.setResPartner2(null);
	...
	public SaleOrder addSaleOrders3(SaleOrder saleOrders3) {
		...
		saleOrders3.setResPartner3(this);
	...
	public HrEmployee addHrEmployees1(HrEmployee hrEmployees1) {
		...
		hrEmployees1.setResPartner1(this);
	...
	public HrEmployee removeHrEmployees1(HrEmployee hrEmployees1) {
		...
		hrEmployees1.setResPartner1(null);
	...
	public HrEmployee addHrEmployees2(HrEmployee hrEmployees2) {
		...
		hrEmployees2.setResPartner2(this);
	...
	public HrEmployee removeHrEmployees2(HrEmployee hrEmployees2) {
		...
		hrEmployees2.setResPartner2(null);
